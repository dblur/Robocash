...
(
    ...
    country   varchar(255), --в исходных данных ошибка в слове country :)
    region   varchar(255),
    city     varchar(255),
    street   varchar(255),
    house    varchar(255),
    flat     varchar(255),
    created  timestamp default now(), -- если я правильно понял, что столбцы должны содержать время их
    modified timestamp default now(), -- создания и изменения, тогда я добавил default now()
